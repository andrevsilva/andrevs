const messages = {
    en: {
        translations: {
            ...
            eu:{
                title: "Who am I?",
                text: "Born and raised in Rio de Janeiro, I am 27 years old and passionate about technology. he started early at the age of 13 in the computing area, where at the age of 15 he already had more than 10 clients from different areas in Rio de Janeiro. At the age of 18 in college where a little Engineering prepared me and shortly afterwards I moved to the OR-RJ (Reserve Officers Center) in the Brazilian army and thus starting a brief military career in the area of ​​technology degression and taking courses related to the area where I was responsible for the health of the barracks servers, information security services, a little programming and data integrity. During my time there, I took several courses such as military technologies, intelligence and counterintelligence actions, servers and military programming. At the end of my military service I left the period as 2nd Lieutenant of Communications and from then on I decided to accept the codes even more and as a Front-end Developer where currently it is possible for 5 years in the market working with various technologies such and always keeping myself in constant study and updating the best technologies and practices of today. I live like developing by technology, always looking for new challenges and going after my dream which is to use technology to transform everyone's lives, save people and change the world for the better not be a hero a developer.",
            },
            exp: {
                title: "EXPERIENCES",
                btn: "KNOW MORE"
